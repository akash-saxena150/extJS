...
Ext.define('Ext.aria.grid.header.Container', {
    ...
    ariaGetRenderAttributes: function() {
        ...
        if (!me.isHeader) {
            // the screen readers need the container holding the column headers to have the role row
            el.down('#' + el.id + '-targetEl', true).setAttribute('role', 'row');
        }
    ...
    onHeaderSelect: function(position) {
        ...
        cHeader.addCls(Ext.AriaSupport.ariaItemFocusCls);
    ...
    onHeaderDeselect: function(position) {
        ...
        cHeader.removeCls(Ext.AriaSupport.ariaItemFocusCls);
    },
